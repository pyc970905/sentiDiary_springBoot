package io.bit.sentiDiary.common;
...
public class S3Uploader {
    ...
    private String upload(File uploadFile, String dirName,String originalName) { //입력 파라미터에 originalName 추가
        ...
        String fileName = dirName + "/" + UUID.randomUUID() +"_" + originalName;   // S3에 저장된 파일 이름 random 값 + 기존의 파일명 으로 설정. 기존의 파일명은 upload 메서드 당시 multipartFile 에서 바로 getOriginalFileName으로 가져와서 입력 파라미터로 받기
